...
public class BeanUtil {
     ...
     * @throws InvocationTargetException
     *             如果调用属性的 setter 方法失败 */
    public static <T> Map<String, Object> convertBean(T t) throws IntrospectionException, IllegalAccessException, InvocationTargetException {
